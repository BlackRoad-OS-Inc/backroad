...
BackRoad is BlackRoad's sovereign container management solution, forked from Portainer. It runs on BlackRoad hardware as part of the Road Fleet — our self-hosted infrastructure stack that eliminates cloud dependency.

## Why BackRoad?

Cloud container dashboards require persistent internet and external auth to manage your own containers. BackRoad runs Portainer locally for Docker management across the fleet — full visibility into every container, volume, and network without phoning home.
